#!/bin/bash
# SLURM batch job script for mean teacher learning
...
#SBATCH -o mean_teacher-%j.out        # Output file name with job ID
#SBATCH -e mean_teacher-%j.err        # Error file name with job ID

# Path to your data directory
DATA_DIR="/scratch/lustre/home/mdah0000/images/cropped"

echo "========================================================"
echo "Running Mean Teacher Learning - $(date)"
echo "========================================================"
...
echo "========================================================"
echo "Results are located in: mean_teacher_results"
echo "========================================================"